      ...
      <div className="row  space mt-4">
        ...
        <div className="col-md-5 text-end ">
          ...
          <button type="button" className=" gcolor  me-2">
            <img src="images/import.png" alt="Logo 1" className="logo-1" />Import District
          </button>

          <button type="button" className=" bcolor">
            <img src="images/re-down.png" alt="Logo 1" className="logo-1" /><span> DownloadDistrict</span>
          </button>
...
<div className='header-two'>
  <div className='row'>
    <div className='col dealer-one'><span>Region</span></div>
