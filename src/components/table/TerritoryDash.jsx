...
const TerritoryDash = () => {
  ...
  const handleAddClick = () => {
    ...
    navigate('/addterrytory');
  };


  const handleEditClick = () => {

    navigate('/editterrytory');
  };
  return (
      ...
      <div className="row  space mt-4">
        ...
        <div className="col-md-6 text-end ">
          ...
          <button type="button" className=" gcolor  me-2">
            <img src="images/import.png" alt="Logo 1" className="logo-1" />Import Terrytory
          </button>

          <button type="button" className=" bcolor">
            <img src="images/re-down.png" alt="Logo 1" className="logo-1" />Sample Download Terrytory
          </button>
