...
const AddHsn = () => {
    return (
        <div className='clss-1'>
            <div className='clss2'>
                <span className='clss3'>Add Add HSN/ SAC</span>
            </div>
            <div className='clss4'>
                <form className="center-form">
                    <div className="form-row">
                        <div className="form-group col-md-6">
                            <label htmlFor="roleInput"><span className='text-2'>HSN/ SAC code </span></label>
                        ...
                        <div className="form-group col-md-6">
                            <label htmlFor="roleInput"><span className='text-2'>HSN/ SAC Type </span></label>
                            <select className="form-control-2" aria-label="Default select example">
                                <option selected>select</option>
                                <option value="1">One</option>
                                <option value="2">Two</option>
